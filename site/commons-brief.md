...
The entry is a single-page static web app. Its entire content is the file `index.html` attached to this message (or pasted below it if attachments are not available). Serve that file exactly as it is.
...
- Do not plan. This is a copy task. There is nothing to design.
...
1. On the app's manage page: Publish, visibility public.
2. commonsmade.com/hackathons, Open hackathon, Your entry, Submit, pick `xscapes`, confirm. Screenshot "Entry submitted."
3. Entries close Sep 17. One build per builder, changeable until then.
